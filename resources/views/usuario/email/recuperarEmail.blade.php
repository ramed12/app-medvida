                        ...
                        <td style='padding:36px 30px 42px 30px;'>
                          <table role='presentation' style='width:702px;' cellspacing='0' cellpadding='0' border='0'>
                            <tr>
                              ...
                              <img width='200' src='{!! asset('assets/img/logo.png') !!}'><Br><BR>
                                <h1 style='font-size:22px;margin:0 0 20px 0;font-family:Arial,sans-serif;'>Recuperação de senha <b> MEDVIDA SAÚDE </b></h1>
                                <p style='margin:0 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;'>Olá <b>{!! $user->nome !!}</b>, Tudo bem?</p>
                                <p style='margin:0 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;'>Para alterar sua senha, clique <a href='{!! route('recuperar-senha-store-send', $user->recoverySenha) !!}'>AQUI</a></p>
